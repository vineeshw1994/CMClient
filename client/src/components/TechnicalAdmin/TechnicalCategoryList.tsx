...
//                 className="bg-gray-700 p-4 rounded-lg shadow-md space-y-2"
//               >
//                 <Link to={`/category/${category.id}`} className="text-xl font-semibold text-gray-100">
//                   {category.category}
//                 </Link>
...
//                     ? typeof category.columnMapping === 'string'
//                       ? JSON.stringify(JSON.parse(category.columnMapping), null, 2) 
//                       : JSON.stringify(category.columnMapping, null, 2) 
//                     : 'No columns mapped'}
//                 </pre>
//               </div>
//             ))}
...
//                           <li key={index}>
//                             <strong>{Object.keys(column)[0]}:</strong>{' '}
//                             {JSON.stringify(Object.values(column)[0])}
//                           </li>
//                         ))
//                       ) : (
